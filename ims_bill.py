...
class Bill_App:
    def __init__(self,root):
        ...
        self.root.title(" Smart Wart Billing Software")
        bg_color="#074463"
        title=Label(self.root,bd=12,relief=GROOVE,bg=bg_color,fg="white",text="Billing Software",
        ...
        search_no_btn=Button(F2,command=self.search_item,bg="black",text="Search",fg="white",pady=15,width=11,bd=5,font="arial 15 bold").grid(row=1,column=1,padx=5,pady=5)
        ...
        search_name_btn=Button(F3,command=self.add_item,bg="white",text="Add",fg="Black",pady=15,width=11,bd=5,font="arial 15 bold").grid(row=4,column=1,padx=5,pady=5)
        ...
        m1_lbl=Label(F6,bg=bg_color,fg="white",text="Total Cosmetics Price",font=("times new roman",15,"bold"))\
        ...
        m2_lbl=Label(F6,bg=bg_color,fg="white",text="Total Grocery Price",font=("times new roman",15,"bold"))\
    ...
    def save_bill(self):
        ...
        f1=open("bill/"+self.bill_no.get()+".txt","w")
