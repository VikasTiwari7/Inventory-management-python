...
class login_system:
    def __init__(self,root):
       ...
       # Images
        ...
        title=Label(self.root,text=" Smart Wart Login System",font=("times new roman",40,"bold")
                    ,bg="white",fg="red",bd=10,relief=GROOVE)
        ...
        lbluser=Label(Login_Frame,text=" Username",image=self.user_icon,compound=LEFT,
                      font=("times new roman",20,"bold"),bg="white").grid(row=1,column=0,padx=20)
        ...
        lblpass=Label(Login_Frame,text=" Password",image=self.pass_icon,compound=LEFT,
                      font=("times new roman",20,"bold"),bg="white").grid(row=2,column=0,padx=20)
        txtpass=Entry(Login_Frame,show="*",textvariable=self.pass_,bd=5,relief=GROOVE,
                      font=("",15)).grid(row=2,column=1,padx=20)

        btn_log=Button(Login_Frame,command=self.login,text="Login",width=15,
                       font=("times new roman",14,"bold"),bg="white",fg="red").grid(row=3,column=1,pady=10)
